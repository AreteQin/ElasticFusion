 ...
 public:
  ...
  struct RGBCallback {
   public:
    ...
    void operator()(rs2::frame frame) {
      ...
      memcpy(
          rgbBuffers[bufferIndex].first,
          frame.get_data(),
          frame.as<rs2::video_frame>().get_width()* frame.as<rs2::video_frame>().get_height() * 3);
  ...
  struct DepthCallback {
   public:
    ...
    void operator()(rs2::depth_frame frame) {
